...
// configuration step. It creates a namespace called `cmakeTestRepo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmakeTestRepo::cmake::project_name, cmakeTestRepo::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmakeTestRepo::cmake::project_version);
      return EXIT_SUCCESS;
    }
